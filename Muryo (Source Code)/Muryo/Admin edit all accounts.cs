...
namespace Muryo
{
    public partial class Admin_edit_all_accounts : Form
    {
        ...
        public Admin_edit_all_accounts(Form form, string userName)
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlCon.Open();
                MySqlDataAdapter sqlDa = new MySqlDataAdapter($"select first_name, last_name, birth_day, sex, address, city, phone, email, userName, pass from users", sqlCon);
        ...
        {
            string buildQuery = $"update users set ";
        ...
        private void Admin_edit_all_accounts_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (!goBack)
                Application.Exit();
        }
